...
def parse_opt():
    ...
    parser.add_argument(
        '--input_json',
        type=str,
        default='caption_data/video_annotation.json',
        help='path to the json file containing video info')
    parser.add_argument(
        '--info_json',
        type=str,
        default='caption_data/info.json',
        help='path to the json file containing additional info and vocab')
    parser.add_argument(
        '--caption_json',
        type=str,
        default='caption_data/caption.json',
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=str,
        default=['caption_data/feats/resnet152/'],
        help='path to the directory containing the preprocessed fc feats')

    parser.add_argument('--c3d_feats_dir', type=str, default='caption_data/c3d_feats')
    parser.add_argument(
        '--with_c3d', type=int, default=0, help='whether to use c3d features')


    parser.add_argument('--pop_visual_feats_dir', type=str, default='caption_data/feats/popup_resnet152')
    parser.add_argument(
        '--with_pop_visual', type=int, default=0, help='whether to use popup_resnet152 features')

    parser.add_argument('--selected_tool_feats_dir', type=str, default='caption_data/feats/selected_tool')
    parser.add_argument(
        '--with_selected_tool', type=int, default=0, help='whether to use selected_tool features')
    
    parser.add_argument(
        '--without_visual', type=int, default=0, help='whether to only use popup_resnet152 features and selected_toolfeatures, without visual feature')
    ...
    parser.add_argument(
        '--epochs', type=int, default=301, help='number of epochs')
    parser.add_argument(
    ...
    parser.add_argument(
        '--learning_rate', type=float, default=2e-4, help='learning rate') #4e-4
